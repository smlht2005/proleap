...
*COPY    "HG_NID.MST".
 ***********************************************************
 ***  HG SYSTEM MASTF COPY FILE NAME : HG_NID.MST ....
 ...
 * 健保卡號 ( REPLACE BY 住院通知表傳送日期 + 傳送時 87.05.29)   (40:10)
 ...
 * 保險醫療證號  ( REPLACE BY 合併之住院序號 87.05.29)   (56:12)
...
*COPY    "HO_PEF.MST".
 ***********************************************************
 ***  HO SYSTEM MASTF COPY FILE NAME : HO_PEF.MST ....
 ...
 *************
 * COPY FILE : HT_SYS.SON    85/12/17    作者：謝枝財
 ...
 *************
 * COPY FILE : HT_DPT.MST    84/03/23    作者：謝枝財
...
*COPY    "HT_CHK.MST".
 *************
 * COPY FILE : HT_CHK.MST   84/03/29     作者：謝枝財
...
*COPY    "HT_RPT.MST".
 *************
 * COPY FILE : HT_RPT.MST   84/04/03     作者：謝枝財
...
*COPY    "HT_CLS.MST".
 *************
 * COPY FILE : HT_CLS.MST   84/03/23     作者：謝枝財
...
*COPY    "HT_CTM.MST".
 *************
 * COPY FILE : HT_CTM.MST    84/03/29    作者：謝枝財
...
*COPY    "HT_CTR.MST".
 *************
 * COPY FILE : HT_CTR.MST    90/03/05    作者：謝枝財
 ...
 *************
 * COPY FILE : HT_ITM.MST   84/03/27     作者：謝枝財
...
*COPY    "HT_REF.MST".
 *************
 * COPY FILE : HT_REF.MST    84/04/24    作者：謝枝財
...
*COPY    "HT_SPL.MST".
 *************
 * COPY FILE : HT_SPL.MST   84/03/23     作者：謝枝財
...
*COPY    "HT_BTL.MST".
 *************
 * COPY FILE : HT_BTL.MST   84/03/08     作者：謝枝財
...
*COPY "HT_V03.MST".
 *************
 * COPY FILE : HT_V03.MST   88/07/15     作者：陳志彥
...
*COPY "HT_V02.MST".
 *************
 * COPY FILE : HT_V02.MST   88/07/20     作者：陳志彥
...
*COPY "HT_V05.MST".
 *************
 * COPY FILE : HT_V05.MST   88/08/19     作者：陳志彥
...
*COPY "HT_VNO.MST".
 *************
 * COPY FILE : HT_VNO.MST   88/07/22     作者：陳志彥
...
*COPY "HT_VVV.MST".
 *************
 * COPY FILE : HT_VVV.MST   88/11/04     作者：陳志彥
...
*COPY "HT_VK1.MST".
 *************
 * COPY FILE : HT_VK1.MST   88/07/25     作者：陳志彥
...
*COPY "HT_VK2.MST".
 *************
 * COPY FILE : HT_VK2.MST   88/10/22     作者：陳志彥
...
*COPY "HT_VK3.MST".
 *************
 * COPY FILE : HT_VK3.MST   88/10/22     作者：陳志彥
...
*COPY "HT_VK4.MST".
 *************
 * COPY FILE : HT_VK4.MST   88/07/25     作者：陳志彥
...
*COPY "HT_WRK.MST".
 *************
 * COPY FILE : HT_WRK.MST 871202-871207  作者：謝枝財
...
*COPY "HT_CSP.MST".
 *************
 * COPY FILE : HT_CSP.MST   84/04/18     作者：謝枝財
...
*COPY    "HX_SRM.MST".
 *************
 * COPY FILE : HX_SRM.MST    90/10/10    作者：謝枝財
...
*COPY    "HX_SCT.MST".
 *************
 * COPY FILE : HX_SCT.MST    90/10/10    作者：謝枝財
...
*COPY    "HX_SCD.MST".
 *************
 * COPY FILE : HX_SCD.MST    90/11/01    作者：謝枝財
...
*COPY    "HX_SCC.MST".
 *************
 * COPY FILE : HX_SCC.MST    90/11/02    作者：謝枝財
...
*COPY    "HX_SCM.MST".
 *************
 * COPY FILE : HX_SCM.MST    90/11/01    作者：謝枝財
...
*COPY    "HX_SCH.MST".
 *************
 * COPY FILE : HX_SCH.MST    90/11/01    作者：謝枝財
...
*COPY    "HX_ANN.MST".
 *************
 * COPY FILE : HX_ANN.MST    89/06/09    作者：謝枝財
...
*COPY    "HI_ELC.WRK".
 *******************************************************************************，
*      COPY FILE : HI_ELC.WRK          電子病歷/申報主機 共用WORK
...
*COPY    "HI_DTE.WRK".
 *******************************************************************************
*      COPY FILE :     HI_DTE.WRK      申報鎖檔月份共用WORK
...
*COPY    "HI_ICA.WRK".
* ***************************************************************************
**>      COPY FILE : HI_ICA.WRK                  used by HIOD2MF, HIOD3DF
*                                                      HISINBF
*      ICA-MST WORKING
...
*COPY    "HI_ICB.WRK".
 *******************************************************************************
 *       COPY FILE :     HI_ICB.WRK      USED BY : HIOD1KF, HIOD2MF, HIOD3DF
...
*COPY    "HI_GCA.WRK".
 *********************************************************************************
 *       COPY    FILE : HI_GCA.WRK       USED BY : HIOD1KF, HIOD2MF, HIOD3DF     *
...
*COPY    "HT_W01.LNK".
 *************
 * COPY FILE : HT_W01.LNK   84/08/03     作者：謝枝財
...
*COPY    "HT_PATR.LNK".
 *************
 * COPY FILE : HT_PATR.LNK  88/09/22     作者：謝枝財
...
*COPY    "HT_VVV0.WRK".
 *************
 * COPY FILE : HT_VVV.WRK 88/11/04       作者：陳志彥
...
*COPY    "HT_ODRW.LNK".
 *************
 * COPY FILE : MT_ODRW.LNK 890424-890510 作者：謝枝財
 ...
 *************
 * COPY FILE : HX_GSCH.LNK 901106-910318  作者：謝枝財
...
*COPY    "HI_KMPCF.LNK".
 ******************************************************************************
 *       COPY FILE : HI_KMPCF.LNK        呼叫    HIKMPCF 傳遞之參數
...
*      MOVE 'HT_PAT0.PRC'      TO W-PTDECF-COPY-FILE.
...
*COPY    "HI_DTE.PRC".
* ****************************************************************************
* COPY FILE : HI_DTE.PRC  CHECK 申報審核鎖檔，整帳鎖檔 HIOD1KF 醫令相關作業
...
*COPY    "HI_ELC.PRC".
 **************************************************************
* COPY FILE : HI_ELC.PRC       HR_ELC.TRN 寫檔共用段
...
*COPY    "HI_GCA2.PRC".
 *********************************************************************************
 *       COPY    FILE : HI_GCA2.PRC      USED BY : HIOD2MF、醫令系統(宜霏)       *
